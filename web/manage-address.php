...
<section class="vg-address-page">
    ...
    <div class="vg-address-container">
        ...
        <div class="vg-saved-address-grid">
            ...
            <article class="vg-address-card vg-default-address">

                <div class="vg-address-card-top">

                    <div class="vg-address-card-tags">
                    ...
                    <div class="vg-address-menu">
                        ...
                        <button type="button"
                                class="vg-address-action delete"
                ...
                <div class="vg-address-person">

                    <span class="vg-person-icon">
                ...
                <div class="vg-address-card-footer">

                    <span class="vg-delivery-ready">
                        <i class="fa-solid fa-circle-check"></i>
                        Ready for delivery
                    </span>

                    <span class="vg-default-text">
                        Default Address
                    </span>
            ...
            <article class="vg-address-card">

                <div class="vg-address-card-top">

                    <div class="vg-address-card-tags">

                        <span class="vg-address-type office">
            ...
            <article class="vg-address-card">
                ...
                <div class="vg-address-card-top">
                    ...
                    <div class="vg-address-card-tags">
                        ...
                        <span class="vg-address-type other">
                            <i class="fa-solid fa-location-dot"></i>
                            Other
                        </span>
